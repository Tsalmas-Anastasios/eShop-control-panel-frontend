...
// class for the product inventories with options for dtTable
export class ProductInventoryMainDataDtOptions extends ProductInventoryMainData {

    created_by__full_name: string;
    view_pdf: any;

    constructor(props?: ProductInventoryMainDataDtOptions) {

        super(props);
        this.created_by__full_name = props?.created_by__full_name || null;
        this.view_pdf = props?.view_pdf || {};
