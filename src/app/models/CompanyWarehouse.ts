...
export class CompanyWarehouseListingObject extends CompanyWarehouse {

    distinctive_title_link: any;
    runways_counter: number;
    quick_actions__preview: any;
    quick_actions__edit?: any;
    quick_actions__delete?: any;

    constructor(props?: CompanyWarehouseListingObject) {

        super(props);
        this.distinctive_title_link = props?.distinctive_title_link || null;
        this.runways_counter = props?.runways_counter || 0;
        this.quick_actions__preview = props?.quick_actions__preview || null;
        this.quick_actions__edit = props?.quick_actions__edit || null;
        this.quick_actions__delete = props?.quick_actions__delete || null;
