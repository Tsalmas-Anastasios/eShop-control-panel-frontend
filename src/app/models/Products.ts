...
export class ProductExtendLinks extends Product {

    product_code_link?: any;
    total_price?: number;

    constructor(props?: ProductExtendLinks) {

        super(props);
        this.product_code_link = props?.product_code_link || null;
        this.total_price = props?.total_price || null;
