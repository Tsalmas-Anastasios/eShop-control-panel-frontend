...
export class WarehousesGuard implements CanActivate {
    ...
    isAuthenticated(): boolean {
        ...
        return !(!user?.is_account && !privileges.warehouses_read && !privileges.warehouses_edit && !privileges.warehouses_new);
